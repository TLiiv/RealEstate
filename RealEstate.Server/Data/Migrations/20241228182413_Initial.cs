        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FloorsInTotal = table.Column<int>(type: "int", nullable: false),
                    HeatingSource = table.Column<string>(type: "nvarchar(max)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_UserPostDetails", x => x.Id);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_UserPost_City_CityId",
                        column: x => x.CityId,
                        principalTable: "City",
                        principalColumn: "CityId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserPost_County_CountyId",
                        column: x => x.CountyId,
                        principalTable: "County",
                        principalColumn: "CountyId",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_UserPost_District_DistrictId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Images_UserPost_UserPostId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UserPost_CityId",
                table: "UserPost",
                column: "CityId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPost_CountyId",
                table: "UserPost",
                column: "CountyId");

            migrationBuilder.CreateIndex(
                name: "IX_UserPost_DistrictId",
                table: "UserPost",
                column: "DistrictId");
